...
export const ErrorState = ({
  ...
  if (isServerWaking) {
    return (
      <div
        className={`text-center py-10 px-6 rounded-2xl border border-indigo-100/80 bg-gradient-to-b from-slate-50 via-indigo-50/30 to-white shadow-subtle flex flex-col items-center justify-center max-w-lg mx-auto ${className}`}
      >
        ...
        <div className="relative mb-4">
          <div className="w-14 h-14 rounded-2xl bg-indigo-100/80 flex items-center justify-center text-indigo-600 shadow-inner">
            <Server className="w-6 h-6 animate-pulse text-indigo-600" />
          </div>
        ...
        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-50 border border-amber-200/80 text-[11px] font-medium text-amber-800 mb-2.5">
  ...
  return (
    <div
      className={`text-center py-10 px-6 rounded-xl border border-rose-100 bg-rose-50/40 flex flex-col items-center justify-center max-w-lg mx-auto ${className}`}
    >
