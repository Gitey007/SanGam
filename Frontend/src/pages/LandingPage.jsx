...
export const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white flex flex-col selection:bg-brand-100 selection:text-brand-900">
      {/* Top Navbar */}
      <header className="border-b border-slate-100 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xs sticky top-0 z-30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-slate-900 dark:bg-brand-600 flex items-center justify-center text-white font-bold text-sm">
              SG
            </div>
            <span className="font-semibold text-base text-slate-900 dark:text-white tracking-tight">SanGam</span>
          </div>
      ...
      <main className="flex-1">
        <section className="pt-16 pb-20 sm:pt-24 sm:pb-28 max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-xs font-medium text-slate-600 dark:text-slate-300 mb-8">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
            <span>Built for college students & innovators</span>
          </div>

          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1] max-w-3xl mx-auto text-balance">
            Find people. <br />
            <span className="text-slate-500 dark:text-slate-400">Build something together.</span>
          </h1>
        ...
        <section className="py-16 bg-slate-50 dark:bg-slate-800/40 border-y border-slate-200/80 dark:border-slate-800">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-12">
              <h2 className="text-xs font-semibold text-slate-400 dark:text-slate-400 uppercase tracking-wider mb-2">
                How it works
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Step 1 */}
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 shadow-subtle flex flex-col justify-between">
                <div>
                  <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center text-slate-900 dark:text-white mb-4 font-semibold text-sm">
                    01
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-700 text-xs font-medium text-slate-400 dark:text-slate-500">
        ...
        <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-3 text-xs text-slate-700 dark:text-slate-300">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span>Flexible authentication with secure passwords and verified accounts</span>
                </div>
                <div className="flex items-center gap-2.5">
                  <div className="w-4 h-4 rounded-full bg-emerald-100 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400 flex items-center justify-center shrink-0">
                    <Check className="w-2.5 h-2.5 stroke-[3]" />
            ...
            {/* Preview Card Mock */}
            <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-card">
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-5 shadow-subtle">
                ...
                <div className="flex flex-wrap gap-1.5 mt-3">
                  <span className="text-[11px] bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-600">
                    Java
                  </span>
                  <span className="text-[11px] bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-600">
                    Spring Boot
